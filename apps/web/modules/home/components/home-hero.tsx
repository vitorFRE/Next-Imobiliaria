...
export function HomeHero() {
  return (
    <header className="relative flex min-h-svh flex-col overflow-hidden pt-20">
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col justify-center py-10 md:py-14">
        <HomeContainer className="grid grid-cols-12 gap-8">
      ...
      <div className="relative z-10 shrink-0 pb-8 pt-2 md:pb-10">
        <HomeContainer className="flex flex-col gap-4 font-sans text-xs font-semibold tracking-[0.2em] uppercase text-foreground/90 sm:flex-row sm:items-center sm:gap-10 md:gap-12 [text-shadow:0_1px_0_rgba(255,255,255,0.85)] dark:text-shadow-none">
